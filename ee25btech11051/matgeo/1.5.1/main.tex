...
\begin{align}
    \myvec{0 \\ y_1} = \brak{\frac{k\myvec{6 \\ -4}+\myvec{-2 \\ -7}}{k+1}}
    \label{0.4}
\end{align}
On further solving,

\begin{align}
    6k-2=0 \implies k = \frac{1}{3}
    \label{0.5}
\end{align}

On substituting \ref{0.5} in \ref{0.4}, We get

\begin{align}
    y_1 = \frac{-25}{4}
\end{align}

We can see that we get the same result by plotting the graph
